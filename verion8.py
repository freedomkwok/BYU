...
model_path = "/kaggle/input/model46/pytorch/default/1/motor_detector_shared_optuna_trial_45/weights/best.pt"
...
CONCENTRATION = 0.8 # ONLY PROCESS 1/20 slices for fast submission
BOX_PRECENTAGE = 0.07
